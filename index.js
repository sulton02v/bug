/*
       ...
       RESMI DARI LynnZxD [ D.E.V ]

  LARANGAN
 
- DI LARANG MEMPERJUAL SC LynnZxD
- DI LARANG MEMPERBAGI SC LynnZxD
...
const phoneNumber = await question('𝙈𝘼𝙎𝙐𝙆𝙄𝙉 𝙉𝙊𝙈𝙊𝙍𝙇𝙐 𝙔𝘼𝙉𝙂 𝙈𝘼𝙐 𝙅𝘼𝘿𝙄 𝙇𝙮𝙣𝙣𝘽𝙪𝙜 😈😈 :\n');
